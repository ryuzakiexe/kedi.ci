<%@ Page Title="" Language="C#" MasterPageFile="~/Yonetici.Master.Master" AutoEventWireup="true" CodeBehind="MakaleListele.aspx.cs" Inherits="kedi.ci.MakaleListele" %>
            ...
            <asp:ListView ID="lv_Makaleler" runat="server" OnItemCommand="lv_Makaleler_ItemCommand">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <a href='MakaleDüzenle.aspx?mid=<%# Eval("ID") %>' class="tablobutton duzenle">Düzenle</a>
