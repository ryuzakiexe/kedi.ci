<%@ Page Title="" Language="C#" MasterPageFile="~/Yonetici.Master.Master" AutoEventWireup="true" CodeBehind="KategoriListele.aspx.cs" Inherits="kedi.ci.KategoriListele" %>
            ...
            <asp:ListView ID="lv_Kategoriler" runat="server" OnItemCommand="lv_Kategoriler_ItemCommand">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <a href='KategoriDüzenle.aspx?kid=<%# Eval("ID") %>' class="tablobutton duzenle">Düzenle</a>
